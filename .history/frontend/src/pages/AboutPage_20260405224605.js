    ...
    <div className="about-page">
      ...
      <section className="section about-section">
        <div className="section-container">
          <div className="creators-box">
            <h2 className="creators-title font-syne">Created for a Safer Internet</h2>
            <p className="creators-subtitle">
              ToxiScan is a proof-of-concept project demonstrating how modern AI and NLP can be applied to create safer online communities.
            </p>
            <p className="creators-tech">
              Built with ❤️ using <strong>React</strong>, <strong>Node.js</strong>, <strong>HuggingFace</strong>, and <strong>RuBERT</strong>
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="about-footer">
        <div className="footer-content-about">
          <p className="footer-text-about">© 2026 ToxiScan. Building safer internet communities through AI.</p>
